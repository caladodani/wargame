...
INSERT INTO medal (id,name,description,metric,threshold,bonus,sort,country_tag) VALUES
 ('IND_baptismo','Sainya Seva Medal','Aguentou a primeira batalha até ao fim.','battles',1,0.01,1,'IND'),
 ('IND_assalto','Shaurya Chakra','Tomou três regiões ao inimigo.','captures',3,0.03,2,'IND'),
